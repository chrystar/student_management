...
class StudentNewsFeed extends StatefulWidget {
  const StudentNewsFeed({super.key});

  @override
  State<StudentNewsFeed> createState() => _StudentNewsFeedState();
}

class _StudentNewsFeedState extends State<StudentNewsFeed> {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text(
            'News and announcements from your lecturers will appear here',
  ...
  Widget _buildNewsFeed() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return StudentNewsCard(newsItem: item);
      },
    );
  }
}

class StudentNewsCard extends StatelessWidget {
  final NewsItem newsItem;

  const StudentNewsCard({
    Key? key,
